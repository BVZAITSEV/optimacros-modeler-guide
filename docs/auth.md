...
![Диалог регистрации](auth-register-dialog.png)
...
![Профиль пользователя](auth-profile-panel.png)

### Account Info

В блоке Account Info вы можете исправить **имя** (First Name)  и **фамилию** (Last Name). Поля доступны для редактирования. Для сохранения изменений нажмите значок ![](auth-change-icon.png) справа от соответствующего поля.
...
![Авторизация-Правая-Панель](auth-right-panel.png)
...
![Диалог входа в систему](auth-sign-in-dialog.png)
...
![Некорректные аутентификационные данные](auth-no-user-found.png)
...
![Диалог смены пароля](auth-reset-password.png)
...
![Диалог установки нового пароля](auth-new-password.png)
...
![Сообщение об установке нового пароля](auth-new-password-set.png)

Чтобы войти в систему, нужно перейти по ссылке **Sign in with new password**.  



После входа в систему вы можете создать новую модель. Информация о том, как создать модель, представлена в разделе [Создание модели](model-creation.md).

Если администратор предоставил вам доступ к уже созданной модели, изучите раздел [Управление моделями](model-control.md).