...
Кнопки ![Модель кнопка список](model-button-list.png) и ![Модель кнопка карточки](model-button-cards.png) переключают отображение моделей c карточек на список и обратно.
...
![Рабочее пространство модели](model-workspace.png)
...
![Действия с моделью](model-control-menu.png)
...
![Избранное](model-control-favorite.png)
...
![Переместить](model-control-move.png)
...
![Модель Offline](model-control-offline.png)
...
![Зона загрузки файлов](model-control-file-drop-zone.png)

После перетаскивания появится диалог с запросом подтверждения:

![Диалог подтверждеия загрузки](model-control-file-drop-comfirmation-dialog.png)

При утвердительном ответе начинается загрузка архива на сервер:

![Звгрузка архива модели](model-control-file-drop-upload-info.png)
...
![](model-control-file-drop-make-online-info.png)
...
![Создать папку](model-control-create-folder-menu.png)
...
![Папки - контекстное меню](model-control-folder-commands.png)
